    ...
    def fit(self):
        ...
        tasks_missings = {
            'task 1': ['incubation', 'stability', 'seasonality', 'season', 'winter', 'spring', 'summer', 'autumn','prediodically',
                       'carrying', 'transference', 'immunity', 'immune','quarantine'],
            'task 2': ['danger', 'hazard', 'exposure'],
            'task 3': ['genetic', 'origin'],
            'task 4': ['interventions', 'non-pharmaceutical'],
            'task 5': ['therapeutics'],
            'task 6': ['considerations', 'published'],
            'task 8': ['published', 'prevent', 'precaution', 'inhibit', 'block', 'avoid', 'forbid', 'avert'],
            'task 9': ['inter-sectoral', 'collaboration', 'published', 'sharing', 'information-sharing']
        }
